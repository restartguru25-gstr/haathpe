...
> {
  ...
  render() {
    if (this.state.hasError && this.state.error) {
      ...
      const isChunkLoad = /failed to fetch dynamically imported module|loading chunk|chunkloaderror/i.test(msg);
      ...
      return (
        ...
        >
          ...
          {isChunkLoad ? (
            <p style={{ color: "#64748b", fontSize: "0.9375rem", marginBottom: 16 }}>
